...
export class SeriesService {
  ...
  private _serieses: Series[] = [
    ...
    {id: 52, name: 'Motivate', brandId: 2},
    {id: 53, name: 'Occasional Tables', brandId: 2},
    {id: 54, name: 'Olson - 4040 Series', brandId: 2},
    {id: 55, name: 'Pagoda', brandId: 2},
    {id: 56, name: 'Park Avenue', brandId: 2},
    {id: 57, name: 'Pennsylvania Avenue', brandId: 2},
    {id: 58, name: 'Perpetual', brandId: 2},
    {id: 59, name: 'Preside', brandId: 2},
    {id: 60, name: 'Private Label', brandId: 2},
    {id: 61, name: 'Riley', brandId: 2},
    {id: 62, name: 'Smartlink', brandId: 2},
    {id: 63, name: 'Solutions', brandId: 2},
    {id: 64, name: 'Solve', brandId: 2},
    {id: 65, name: 'Soothe', brandId: 2},
    {id: 66, name: 'StationMaster', brandId: 2},
    {id: 67, name: 'Systems', brandId: 2},
    {id: 68, name: 'Valido', brandId: 2},
    {id: 69, name: 'Verse', brandId: 2},
    {id: 70, name: 'Voi', brandId: 2},
    {id: 71, name: 'Prefix', brandId: 3},
    {id: 72, name: 'Surpass', brandId: 3},
  ];
